...
import {FieldListUrl, FieldThumbnailUrl, FieldFormUrl} from '../../fields/url'
...
describe('URL Thumbnail component', () => {
    const renderer = require('vue-server-renderer').createRenderer();
    beforeEach(() => {
        store.dispatch('UNITEST_CLEAR');
    });
    it('Render', () => {
        const vm = new Vue({
            ...
            router,
            i18n,
            render: h => h(FieldThumbnailUrl, {props: {
