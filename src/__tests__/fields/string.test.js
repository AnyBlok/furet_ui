...
import {FieldListString, FieldThumbnailString, FieldFormString} from '../../fields/string'
...
describe('String list component', () => {
    ...
    it('Render with data', () => {
        const vm = new Vue({
            ...
            router,
            i18n,
            render: h => h(FieldListString, {props: {
...
describe('String Thumbnail component', () => {
    ...
    it('Render', () => {
        const vm = new Vue({
            ...
            router,
            i18n,
            render: h => h(FieldThumbnailString, {props: {
...
describe('String Form component', () => {
    ...
    it('Render', () => {
        const vm = new Vue({
            ...
            router,
            i18n,
            render: h => h(FieldFormString, {props: {
